...
- **Does option A extend to overwriting an instruction that IS executed?** Not
  needed so far: every case examined turned out to be data, alignment or a dead
  epilogue. Ask again when a real one appears.
