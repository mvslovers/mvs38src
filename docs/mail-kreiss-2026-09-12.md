# Mail to Dave Kreiss — **sent 2026-09-12**

> Sent. Three things wait on his answer: the `./ DELETE` question, the macro
> list, and his rebuilt `PVTMAC`/`APVTMAC` on the new install tape. None of them
> blocks host-side work.
